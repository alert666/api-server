...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Oauth2User = userHasOneOauth2User{
		...
		RelationField: field.NewRelation("Oauth2User", "model.Oauth2User"),
		User: struct {
			field.RelationField
			Oauth2User struct {
				field.RelationField
			...
			RelationField: field.NewRelation("Oauth2User.User", "model.User"),
			Oauth2User: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Oauth2User.User.Oauth2User", "model.Oauth2User"),
			},
			Roles: struct {
				field.RelationField
				Users struct {
				...
				RelationField: field.NewRelation("Oauth2User.User.Roles", "model.Role"),
				Users: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Oauth2User.User.Roles.Users", "model.User"),
				},
				Apis: struct {
					field.RelationField
					Roles struct {
					...
					RelationField: field.NewRelation("Oauth2User.User.Roles.Apis", "model.Api"),
					Roles: struct {
						field.RelationField
					}{
						RelationField: field.NewRelation("Oauth2User.User.Roles.Apis.Roles", "model.Role"),
					},
				},
			},
		},
...
func (u user) clone(db *gorm.DB) user {
	...
	u.Oauth2User.db = db.Session(&gorm.Session{Initialized: true})
	u.Oauth2User.db.Statement.ConnPool = db.Statement.ConnPool
...
func (u user) replaceDB(db *gorm.DB) user {
	...
	u.Oauth2User.db = db.Session(&gorm.Session{})
	u.Roles.db = db.Session(&gorm.Session{})
	return u
}

type userHasOneOauth2User struct {
	db *gorm.DB
...
func (a userHasOneOauth2User) Where(conds ...field.Expr) *userHasOneOauth2User {
	if len(conds) == 0 {
		return &a
	}
...
func (a userHasOneOauth2User) WithContext(ctx context.Context) *userHasOneOauth2User {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a userHasOneOauth2User) Session(session *gorm.Session) *userHasOneOauth2User {
	a.db = a.db.Session(session)
	return &a
}

func (a userHasOneOauth2User) Model(m *model.User) *userHasOneOauth2UserTx {
	return &userHasOneOauth2UserTx{a.db.Model(m).Association(a.Name())}
}

func (a userHasOneOauth2User) Unscoped() *userHasOneOauth2User {
	a.db = a.db.Unscoped()
	return &a
}

type userHasOneOauth2UserTx struct{ tx *gorm.Association }

func (a userHasOneOauth2UserTx) Find() (result *model.Oauth2User, err error) {
	return result, a.tx.Find(&result)
}

func (a userHasOneOauth2UserTx) Append(values ...*model.Oauth2User) (err error) {
...
func (a userHasOneOauth2UserTx) Replace(values ...*model.Oauth2User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userHasOneOauth2UserTx) Delete(values ...*model.Oauth2User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userHasOneOauth2UserTx) Clear() error {
	return a.tx.Clear()
}

func (a userHasOneOauth2UserTx) Count() int64 {
	return a.tx.Count()
}

func (a userHasOneOauth2UserTx) Unscoped() *userHasOneOauth2UserTx {
	a.tx = a.tx.Unscoped()
	return &a
}
