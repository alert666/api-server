...
// @Success 200 {object} types.Response{} "登录成功"
...
// @Accept json
// @Produce json
// @Param provider query string false "OAuth2 provider 名称（如 feishu、keycloak）"
...
// @Accept json
// @Produce json
// @Success 200 {object} types.Response{} "获取成功"
...
// @Success 200 {object} types.Response{} "激活成功"
